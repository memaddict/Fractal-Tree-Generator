...
/*    */ 
/*    */ public class wBG extends JPanel implements ActionListener {
/*    */   private static Image wBackground;
/*    */   private static iJButton bBack;
/*    */   
/*    */   public wBG(String str) {
/* 16 */     setLayout((LayoutManager)null);
/* 17 */     wBackground = (new ImageIcon(str)).getImage();
...
/* Location:              D:\BRIDGE\local Git\Fractal-Tree-Generator-1.0\Tree.jar!\Builder\wBG.class
